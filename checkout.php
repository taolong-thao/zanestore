...
$bansp="SELECT*FROM giayboot";
if (isset($_POST['name']) && isset($_POST['sdt']) && isset($_POST['address']) && isset($_GET['totalMoney'])) {
    $name = $_POST['name'];
    $sdt = $_POST['sdt'];
    $address = $_POST['address'];
    $tt = $_GET['totalMoney'];
    $username = $_SESSION['username'];
    mysqli_query($mysqli, "INSERT INTO `orders`(`username`, `name`, `sdt`, `address`, `totalMoney`) VALUES ('$username','$name','$sdt','$address','$tt')");
    mysqli_query($mysqli, "DELETE FROM `cart` WHERE `username`='$username'");
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-6 mb-3">
                <div class="checkout-address">
                    ...
                    ?>
                    <form class="needs-validation" action="checkout.php?totalMoney=<?php echo $totalMoney; ?>" method="POST" novalidate>
                        <!-- <div class="row">
            ...
            <div class="col-sm-6 col-lg-6 mb-3">
                <div class="row">
                            ...
                            <div class="rounded p-2 bg-light">
                                ...
                                ?>
                                        <div class="media mb-2 border-bottom">
                                            <div class="media-body"> <a href="detail.html"> <?php echo $row['namesp']; ?> </a>
                                                <div class="small text-muted">Price: <?php echo $row['pricesp']; ?> đ <span class="mx-2">|</span> Qty: <?php echo $row['soluongsp']; ?> <span class="mx-2">|</span> Subtotal: <?php echo $row['total']; ?> đ</div>
                                            </div>
                                        </div>
                            </div>
                    <?php }
                    ...
                    <!-- <div class="col-12 d-flex shopping-box"> <a href="checkout.php" class="ml-auto btn hvr-hover">Place Order</a> </div><div class="col-12 d-flex shopping-box"> <a href="checkout.php" class="ml-auto btn hvr-hover">Place Order</a> </div> -->
                </div>
            </div>
        </div>

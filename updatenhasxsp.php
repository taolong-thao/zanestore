<?php 
   ...
   if(count($_POST)>0)
   {
    $updt="UPDATE nhasxsp set nhasx='".$_POST['nhasxsp']."' where nhasx='".$_GET['nhasx']."'";
...
<div id="modal-wrapper" class="modal">
    ...
    <form enctype='multipart/form-data' class="modal-content animate" action="" method="POST">
        ...
        <div class="container">
            ...
            <input type="text" placeholder="<?php echo $row['nhasx']; ?>" value="<?php echo $row['nhasx']; ?>" name="nhasxsp">
             <button type="submit">Sửa thể nhà sản xuất Sản Phẩm</button>
        </div>
